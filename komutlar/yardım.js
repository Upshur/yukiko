...
const yardım = new Discord.MessageEmbed()
  .setAuthor(`YUKİKO Yardım Menüsü`, client.user.avatarURL())
  .setColor("0x36393F")
  ...
  .addField(" • Linkler:", "• [Davet Et](Link) • [Destek Sunucusu](https://discord.gg/YV6qrhPEBZ) • [Web Site](Link) •")
  .setImage("https://cdn.discordapp.com/attachments/856933069884489780/879885121174528020/yukiko2.png")
.setFooter("YUKİKO", message.author.avatarURL())
.setTimestamp()
